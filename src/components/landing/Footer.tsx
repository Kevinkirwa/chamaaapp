      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <span className="text-2xl font-bold">M-Chama</span>
            </div>
            
            <p className="text-gray-400 mb-6 leading-relaxed max-w-md">
              Empowering Kenyan communities through digital savings groups. 
              Build wealth together with secure, transparent, and automated Chama management.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">hello@mchama.co.ke</span>
              </li>
              <li className="flex items-center space-x-3">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 M-Chama. All rights reserved.
          </p>
